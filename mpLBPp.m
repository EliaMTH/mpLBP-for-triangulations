function [mpLBPdes,punct_mpLBPdes]=mpLBPp(v,f,R,nrad,multP,hfun,main_dir,normals)
%% Mean Point Local Binary Pattern (mpLBP)
%
% The mpLBP function computes the mpLBP descriptor from an input
% triangulation and a set of parameters. It first computes the punctual
% descriptor (or mpLBP punctual descriptor) on each vertex, then it
% computes the LBP and, finally, it computes the mpLBP descriptor, which is 
% basically a histogram of the punctual descriptors.
% 
% If you use this using this code, PLEASE cite us. You can find the bibtex 
% in the same docs_and_readmes folder. 
%
...
%           - hfun       : the descriptor of the pattern, an array with nv 
